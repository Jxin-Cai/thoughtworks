...
- `/thoughtworks-frontend` — 前端 Decision-Maker 主 skill
- `/thoughtworks-frontend-thought` — 读取 workflow.yaml 决定 thinker 启动顺序
- `/thoughtworks-frontend-works` — 读取 workflow.yaml 决定执行顺序，调用 frontend-status.sh 查询状态
