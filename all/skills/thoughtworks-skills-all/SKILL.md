...
使用 Read 工具分别读取以下两个文件，按其中的选项表和级联规则处理：
- `{DDD_HELP}/references/interrupt-cascade.md`（后端级联）
- `{FRONTEND_HELP}/references/interrupt-cascade.md`（前端级联）
...
- `{DDD_HELP}/references/rationalization-backend.md`
- `references/rationalization-fullstack.md`
