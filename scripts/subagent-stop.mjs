...
for (const taskFile of taskFiles) {
  ...
  let statusScript;
  if (stack === 'frontend') {
    statusScript = resolve(PLUGIN_ROOT, 'skills/frontend-help/scripts/frontend-workflow-status.mjs');
  } else {
    statusScript = resolve(PLUGIN_ROOT, 'skills/backend-help/scripts/backend-workflow-status.mjs');
  }
